...
export default function RootLayout({
  ...
  const isCaptionSurface = pathname === '/caption-overlay' || pathname === '/caption-settings'

  return (
    <html lang="zh-CN" className={isCaptionSurface ? 'caption-overlay-root' : undefined}>
      <body
        className={`${sourceSans3.variable} meetily-font antialiased ${isCaptionSurface ? 'caption-overlay-body' : ''}`}
      >
        {isCaptionSurface ? children : <MainAppLayout>{children}</MainAppLayout>}
      </body>
    </html>
  )
}
