...
import { EMPTY_SUMMARY_API_KEY_CONFIGURED } from '@/services/configService';
          ...
          {item.type === 'folder' ? (
            <>
              ...
              {searchQuery && item.id === 'meetings' && isSearching && (
                <span className="ml-2 text-xs text-blue-500 animate-pulse">正在搜索…</span>
              )}
            </>
          ) : (
