...
import type { TranscriptModelConfig } from '@/types/transcription-config';
 ...
 */
export function useModalState(transcriptModelConfig?: TranscriptModelConfig): UseModalStateReturn {
