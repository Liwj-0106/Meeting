...
for %%D in (
    ...
    "%MEETILY_DATA_DIR%\models\ollama"
    "%MEETILY_PORTABLE%\cargo-target"
    ...
    "%MEETILY_PORTABLE%\pnpm-cache"
    "%MEETILY_PORTABLE%\pnpm-store"
    "%MEETILY_PORTABLE%\tool-cache"
    "%MEETILY_PORTABLE%\tool-config"
    "%MEETILY_PORTABLE%\tool-data"
    "%MEETILY_PORTABLE%\tool-state"
...
call "%MEETILY_ROOT%\scripts\run-meetily-portable.cmd"
exit /b %errorlevel%
